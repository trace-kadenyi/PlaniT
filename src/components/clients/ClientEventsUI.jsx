...
export default function ClientEventsUI({ event, Link }) {
  return (
    <li
      key={event._id}
      className="bg-white p-5 rounded-xl border border-[#F3E8FF] hover:border-[#F59E0B] shadow-sm hover:shadow-md transition-all duration-200 dark:bg-gradient-to-b dark:from-[#1a1026] dark:to-black dark:border-[#F59E0B]/10 dark:hover:border-[#F59E0B]/20"
    >
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        ...
        <div className="mt-3 md:mt-0 flex flex-col text-xs gap-3 sm:gap-1">
          <span className="flex items-center gap-3">
            {" "}
            <span className="font-semibold text-gray-500 dark:text-gray-400"> Event date: </span>
