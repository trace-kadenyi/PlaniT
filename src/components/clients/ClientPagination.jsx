export default function ClientPagination({
  ...
  return (
    <div className="px-6 py-3 flex items-center justify-between border-t border-gray-200 dark:border-gray-900 dark:bg-gray-900">
        ...
        <div>
          ...
          >
            <button
              onClick={() => paginate(Math.max(1, currentPage - 1))}
              disabled={currentPage === 1}
              className={`relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium dark:bg-gray-800 dark:border-gray-700 ${
                currentPage === 1
