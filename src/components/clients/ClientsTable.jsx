...
export default function ClientsTable({
  ...
  return (
    <div className="minimal-scrollbar overflow-x-auto border border-gray-200 dark:bg-gradient-to-b dark:from-[#1a1026] dark:to-black dark:border-gray-800 rounded-lg">
