        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
          ...
          <div className="px-8 pt-6 pb-0 bg-white">
            <button
              ...
              className="w-full group flex items-center justify-between px-4 py-3 rounded-xl border border-[#9B2C62]/20 bg-gradient-to-r from-[#9B2C62]/5 to-[#F59E0B]/5 hover:from-[#9B2C62]/10 hover:to-[#F59E0B]/10 hover:border-[#9B2C62]/40 transition-all duration-200"
            >
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#9B2C62] to-[#F59E0B] flex items-center justify-center flex-shrink-0">
                ...
                <div className="text-left">
                  <p className="text-sm font-semibold text-[#9B2C62]">See what you're signing up for</p>
                  <p className="text-xs text-gray-500">Explore features before creating your account</p>
                </div>
              </div>
              <svg className="w-4 h-4 text-[#9B2C62]/50 group-hover:text-[#9B2C62] group-hover:translate-x-0.5 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
